export async function prelude() {
    ...
    */
    ...
    await new Promise(resolve => {
        window.hyperbeamPromiseResolver = resolve;
        const s = document.createElement('script');
        s.type = "module"
        s.innerHTML = `
import Hyperbeam from 'https://cdn.jsdelivr.net/npm/@hyperbeam/web@0.0.29/+esm';
console.log("script tag", Hyperbeam);
window.Hyperbeam = Hyperbeam;
window.hyperbeamPromiseResolver(Hyperbeam);
`
